...
let times_faster (b1 : bignum) (b2 : bignum) : bignum =
  ...
  | _ -> let (init1, last1) = get_init (List.rev b1.coeffs) 3 in
         ...
         let i1num = {neg = false; coeffs = List.rev init1} in 
         let l1num = {neg = false; coeffs = List.rev last1} in 
         let i2num = {neg = false; coeffs = List.rev init2} in 
         let l2num = {neg = false; coeffs = List.rev last2} in 
         let z2 = times l1num l2num in
         let z0 = times i1num i2num in 
         let z1 = plus (plus (times (plus i1num l1num) (plus i2num l2num)) z2) z0 in 
