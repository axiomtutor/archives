...
let aitken (s: float stream) : float stream =
  let sn1 = tail s in 
  let sn2 = tail sn1 in 
  let num = smap2 (fun x y -> (x -. y) ** 2.) sn2 sn1 in 
  let den = smap2 (fun a b -> a +. b) 
                  (smap2 (fun x y -> (x -. (2. *. y))) sn2 sn1) 
                  s in
  let div = smap2 (fun x y -> x /. y) num den in 
  smap2 (fun x y -> x -. y) sn2 div ;;
...
let node (t : 'a tree) : 'a = fst (Lazy.force t) ;;  

(*......................................................................
children t -- Returns the list of children of the root node of tree `t`.
......................................................................*)
   
let children (t : 'a tree) : 'a tree list = snd (Lazy.force t) ;;
