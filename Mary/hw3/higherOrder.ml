...
let rec assoc (key: 'k) (l: ('k * 'v) list) : 'v =
  failwith "HigherOrder.assoc: not implemented"
...
let capitalize (l: string list) : string list =
  failwith "HigherOrder.capitalize: unimplemented"
...
let list_length (l: 'a list) : int =
  failwith "HigherOrder.list_length: unimplemented"
...
let concat (l: 'a list list) : 'a list =
  failwith "HigherOrder.concat: unimplemented"
...
let reverse (l: 'a list) : 'a list =
  failwith "HigherOrder.reverse: unimplemented"
...
let for_all (pred: 'a -> bool) (l: 'a list) : bool =
  failwith "HigherOrder.for_all: unimplemented"
...
let exists (pred: 'a -> bool) (l: 'a list) : bool =
  failwith "HigherOrder.exists: unimplemented"
...
let ho_filter (pred: 'a -> bool) (l: 'a list) : 'a list =
  failwith "HigherOrder.ho_filter: unimplemented"
