...
let count_if (pred: 'a -> bool) (l: 'a list) : int =
  failwith "Vocab.count_if: unimplemented"
...
let count_words_in_text (vocabulary: string list) (text: string set) : int =
  failwith "Vocab.count_words_in_text: unimplemented"
...
let count_sat_words: string set -> int =
  fun _ -> failwith "Vocab.count_sat_words: unimplemented"
...
let modest_sat_words  : int = 0
let weak_sat_words    : int = 0
let twentyk_sat_words : int = 0
...
let count_length_gt7 (s: string set) : int =
  failwith "Vocab.count_length_gt7: unimplemented"
...
let modest_length_gt7  : int = 0
let weak_length_gt7    : int = 0
let twentyk_length_gt7 : int = 0
